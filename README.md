...
<p>
  ...
  <img src="https://img.shields.io/badge/gRPC-00B140?style=for-the-badge&logo=grpc&logoColor=white">
...
<p>
  ...
  <img src="https://img.shields.io/badge/Qdrant-%23FF6B6B.svg?style=for-the-badge&logo=qdrant&logoColor=white">
</p>
...
- Evaluating **vector databases** like **Qdrant** for semantic search and recommendation engine (track embeddings, similar tracks, user preference matching)
- Considering **gRPC** (in Go) for high-performance microservices (e.g., real-time recommendation streaming or metadata service)
- Studying hybrid approaches with PostgreSQL + pgvector vs dedicated vector DBs
📌 **Planned Features:**
- Track/album pages with community reviews
- User collections & playlists
- Intelligent recommendation engine (vector similarity + collaborative filtering)
...
- Potential future migration of high-performance services to **gRPC** (Go) for lower latency in real-time features
